...
#export CLASSPATH=$CLASSPATH:/opt/adrdhadoop/hadoop/share/hadoop/common/lib/hadoop-lzo-0.4.15-gplextras5.0.2-SNAPSHOT.jar:/opt/cloudera/parcels/GPLEXTRAS/lib/hadoop/lib/hadoop-lzo
#### which app ####
